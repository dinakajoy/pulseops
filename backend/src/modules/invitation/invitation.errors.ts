...
export class InvitationExpiredError extends AppError {
  constructor() {
    super(409, "INVITATION_EXPIRED", `Invitation has expired`);
  }
}

export class InvitationRevokedError extends AppError {
  constructor() {
    super(409, "INVITATION_REVOKED", `Invitation has been revoked`);
  }
}
...
export class InvitationAcceptedError extends AppError {
  constructor() {
    super(400, "INVITATION_ACCEPTED", `Invitation has already been accepted`);
  }
}
